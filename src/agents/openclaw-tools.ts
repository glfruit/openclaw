...
import { createOpenClawMediaTools } from "./openclaw-media-tools.js";
...
export function createOpenClawTools(
  ...
  const messageTools = createOpenClawMessageTools({

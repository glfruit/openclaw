...
- Owned-fork work: read `docs/owned/GOVERNANCE.md` plus the scoped owned docs before acting. Do not perform destructive git operations until repository health is verified.
